        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 resize-none focus:outline-none focus:ring-green-500 focus:border-green-500"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <label htmlFor="labelledPrice" className="block text-sm font-medium text-gray-700 mb-1">
                Labelled Price
              </label>
              <input
                id="labelledPrice"
          ...
          <div className="flex justify-between mt-6">
            ...
            <button
              type="submit"
              className="inline-flex justify-center py-2 px-6 border border-transparent shadow-sm text-sm font-semibold cursor-pointer rounded-md text-white bg-emerald-700 hover:bg-emerald-800 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition"
            >
              Add Product
            </button>
          </div>
